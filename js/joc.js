class Joc{
    constructor(canvas,ctx) {
        ...
        // this.totxo2 = new Totxo(new Punt(3*(this.canvas.width-60)/2,(this.canvas.height-20)/3), 60, 20, "#0ad");  // només posem un totxo gegant, per veure els xocs


        this.bola = new Bola(new Punt(this.canvas.width/2,this.canvas.height/2),3);
        this.pala = new Pala(new Punt((this.canvas.width-60)/2,this.canvas.height-15),60,6);
